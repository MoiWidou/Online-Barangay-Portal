...
export default function IndigencyAddress({ triggerHighlight, handleIndigencyAddressFieldsComplete, passInputDataToParent}) {
...
}, [userData, handleIndigencyAddressFieldsComplete, triggerHighlight]);
