...
export default function BusinessInfo({triggerHighlight, handleBusinessInfoFieldsComplete, passInputDataToParent}) {
...
}, [userData, handleBusinessInfoFieldsComplete, triggerHighlight]);
