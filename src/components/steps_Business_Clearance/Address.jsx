...
export default function Address({triggerHighlight, handleAddressInfoFieldsComplete , passInputDataToParent}) {
  ...
  }, [userData, handleAddressInfoFieldsComplete, triggerHighlight]);
