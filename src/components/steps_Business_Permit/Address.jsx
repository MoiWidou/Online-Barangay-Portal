...
export default function Address({ triggerHighlight, handleAddressFieldsComplete, passInputDataToParent }) {
  ...
  }, [userData, handleAddressFieldsComplete, triggerHighlight]);
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="w-full mx-2 flex-1">
        ...
        <div className={`bg-white my-2 p-1 flex border ${highlightedFields.includes("zip-code") ? "border-red-500" : "border-gray-200"} rounded`}>
      ...
      <div className="w-full mx-2 flex-1">
        ...
        <div className={`bg-white my-2 p-1 flex border ${highlightedFields.includes("district") ? "border-red-500" : "border-gray-200"} rounded`}>
